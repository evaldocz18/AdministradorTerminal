...
public class TerminalPesquisaRecyclerAdapter extends RecyclerView.Adapter<TerminalPesquisaRecyclerAdapter.MeuViewHolderListarKiosques> {

    public ArrayList<TerminalPesquisa> listaKiosque;

    private Context context;
    private int posicao = 0;

    public TerminalPesquisaRecyclerAdapter(ArrayList<TerminalPesquisa> listKiosque, Context c){
        context = c;
        listaKiosque = listKiosque;
    }

    public TerminalPesquisaRecyclerAdapter(ArrayList<TerminalPesquisa> listKiosque){
        listaKiosque = listKiosque;
    }
