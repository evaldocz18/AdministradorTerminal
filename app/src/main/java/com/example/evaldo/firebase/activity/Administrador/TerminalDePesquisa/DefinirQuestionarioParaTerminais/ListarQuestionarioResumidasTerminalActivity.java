...
public class ListarQuestionarioResumidasTerminalActivity extends AppCompatActivity {
    ...
    public static ArrayList<TerminalPesquisa> listDispositivoTerminalArrayList = new ArrayList<>();
    RecyclerView recyclerView;

    private DatabaseReference referencePerguntas;
    private DatabaseReference referenceDispositivosTerminais;

    Context context = ListarQuestionarioResumidasTerminalActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_resultados_resumidas_terminal);

        System.out.println("Tela = ListarQuestionarioResumidasTerminalActivity");

        tvNomeQuestionario = findViewById(R.id.tv_listarResultadosResumidosTerminal_nomeQuestionario);
...
/////////Inicializando metodo para atualizar do iniciarFirebasePerguntas
    ...
    private void iniciarRecyclerView() {
        try {
            recyclerView = findViewById(R.id.recyclerView_mostrarResultadosResumidosTerminal);
    ...
    private void chamarlistarTerminais() {
        Intent intent1 = new Intent(context, ListarTerminaisActivity.class);
    ...
    private void iniciarFirebasePerguntas() {
        ...
        referencePerguntas.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                questAdapter = new ResultadosResumidosRecyclerAdapter(listquestListQuestionariosResumidosArrayList, ListarQuestionarioResumidasTerminalActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ListarQuestionarioResumidasTerminalActivity.this, "Erro no iniciarFirebasePerguntas", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void eventoClick() {
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerView_mostrarResultadosResumidosTerminal);
    ...
    public void clicouConfirmarQuestionarioTerminal(View view) {
